...
Q_CONSTINIT static const qt_meta_stringdata_keymanager_t qt_meta_stringdata_keymanager = {
    {
        ...
        QT_MOC_LITERAL(11, 6),  // "ShowMW"
        QT_MOC_LITERAL(18, 0),  // ""
        QT_MOC_LITERAL(19, 24)   // "on_search_buttom_clicked"
    },
    "keymanager",
    "ShowMW",
    "",
    "on_search_buttom_clicked"
};
...
Q_CONSTINIT const QMetaObject keymanager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_keymanager_t,
        ...
        // method 'on_search_buttom_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void keymanager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ShowMW(); break;
        case 1: _t->on_search_buttom_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (keymanager::*)();
            if (_t _q_method = &keymanager::ShowMW; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
